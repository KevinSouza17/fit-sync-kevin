          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input type="text" placeholder="João Silva" className="pl-9" required />
              </div>
            </div>
      ...
      <div className="hidden w-1/2 flex-col justify-between bg-blue-600 p-12 lg:flex">
        ...
        <div className="space-y-4">
          ...
          <p className="text-base leading-relaxed text-blue-100">
            Defina suas metas, acompanhe seu progresso e transforme seus hábitos com o suporte de nossa comunidade e profissionais de saúde.
          </p>
        </div>
