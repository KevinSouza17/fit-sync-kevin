      ...
      <div className="flex w-full flex-col justify-center bg-surface-card px-8 py-12 lg:w-1/2 lg:px-16">
        <div className="mx-auto w-full max-w-md">
          ...
          <button
            ...
            className="mb-4 flex w-full items-center justify-center gap-3 rounded-lg border border-edge-base bg-white px-4 py-2.5 text-sm font-medium text-content-strong shadow-sm transition-all hover:bg-slate-50 hover:shadow-md disabled:opacity-60"
          >
            {googleLoading ? (
          ...
          <div className="mb-4 flex items-center gap-3">
            ...
            <span className="text-xs text-content-muted">ou crie com email</span>
            <div className="h-px flex-1 bg-slate-200" />
          </div>
